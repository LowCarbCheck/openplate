...
**Key Principle:** If the logic doesn't involve synchronizing with an _external system_, you likely don't need `useEffect`.
...
- **Persist** create forms (new food, new user) — not edit forms (server data is authoritative)
- **Never persist** passwords, tokens, or secrets — this includes BYOK AI provider API keys on the AI settings form
