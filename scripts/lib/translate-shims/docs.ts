 ...
 * vendoring a docs site into a food diary. So `scripts/sync-translate-lib.ts` rewrites that
 * import to this file, which declares the NAMES the copy refers to and nothing behind them.
 * No value of these types is ever made in this app; the functions that would walk one, in
...
/** One run of inline text. Opaque here: the app never parses a document. */
