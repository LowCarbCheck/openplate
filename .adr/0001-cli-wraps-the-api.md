...
- **Status:** Superseded (2026-07-09) — the /api/v1 surface and CLI remote transport were removed; the CLI then called the DB layer directly, and in 2026-08 the CLI and the database went too.
- **Date:** 2026-05-13
- **Deciders:** Altan
...
- Auth is via `Authorization: Bearer <api-key>`; the CLI reads it from `FACTORY_API_KEY` or `--token`.
