 ...
 * `IconLeft`/`IconRight` pair). Defined at module scope — and referenced
 ...
 * renderer — the shadcn v8 snippet doesn't drop in as-is, so this mapping was
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: `text-muted-foreground ${CELL_WIDTH} text-[0.8rem] font-normal md:w-9`,
