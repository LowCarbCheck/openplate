/**
 * `/privacy/website`: the `privacy-website` page of the mounted content folder (M246 spec 01).
 *
...
export async function loader({ request }: Route.LoaderArgs) {
  return { page: await loadContentPageOrThrow({ request, slug: 'privacy-website' }) };
}
